...
| `by3` | Bayley Scales for Infant and Toddler Development-3 | 320 |  | 105 | 67 | 172 | 242 |
...
The designs of the original cohorts determine the age coverage for each instrument. The figure above indicates the age range currently supported by the `"gsed2510"` key.
