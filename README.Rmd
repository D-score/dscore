...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](inst/LICENSE)
...
- **Data, keys, and other non-code materials**: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)

This setup complies with [CRAN policies](https://cran.r-project.org/web/licenses/) and the 
[Gates Foundation Open Access Policy](https://openaccess.gatesfoundation.org/open-access-policy/).
